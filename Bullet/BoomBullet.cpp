...
BoomBullet::BoomBullet(Engine::Point position, Engine::Point forwardDirection, float rotation, Turret *parent) : Bullet("play/bullet-3.png", 500, 5, position, forwardDirection, rotation - ALLEGRO_PI / 2, parent) {
}
